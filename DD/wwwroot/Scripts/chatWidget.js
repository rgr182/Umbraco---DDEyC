...
ChatWidget.MessageManager = {
  ...
  createMessage(content, role, message = {}) {
    ...
    if (this.isFirstMessage && role === "assistant") {
      imageHtml = `<img style="width: 100px; height: auto;" src="../assets/marckbot.png" alt="Marckbot" />`;
      this.isFirstMessage = false;
    }
    const flexClass = isFirstMessage ? 'd-flex align-items-center w-75' : '';
