document.addEventListener("DOMContentLoaded", function () {
  ...
  function positionSubmenu(dropdown) {
    if (
      ...
      dropdown.classList.contains("sub-dropdown")
    ) {
  ...
  function closeAllDropdowns() {
    document
      .querySelectorAll(".dropdown.open, .sub-dropdown.open")
      .forEach((dropdown) => {
    ...
    if (dropdown) {
      ...
      parentUl.querySelectorAll(".dropdown, .sub-dropdown").forEach((d) => {
        if (d !== dropdown && d.classList.contains("open")) {
          ...
          const siblingHeader =
            d.parentElement.querySelector(".menu-item-header");
